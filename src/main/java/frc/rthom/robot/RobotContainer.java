...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    m_chooser.addOption("Auto Routine S", 1);
    m_chooser.setDefaultOption("Auto Routine Straight", 2);
    m_chooser.addOption("Auto Bounce Challenge", 3);
    m_chooser.addOption("Auto 2 Straights", 4);
