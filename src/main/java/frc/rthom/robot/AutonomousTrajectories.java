...
/*
    ...
    */
    ...
    String trajectory1JSON = "C:\\Users\\RKT\\frc\\FRC2021\\Code\\Romi\\PathWeaver\\output\\1.wpilib.json"; // works
...
ramseteCommand[idx] =
 new RamseteCommand(
     ...
     if(idx < autoTrajectory.length-1)
       //addCommands(ramseteCommand[idx]);
       addCommands(ramseteCommand[idx].andThen(() -> m_robotDrive.resetOdometry( m_robotDrive.getPose() )));
     else // last is special
